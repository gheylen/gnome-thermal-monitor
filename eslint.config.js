...
// The two shell adapters.  Dependencies point inwards, so nothing under `src/`
// may import either — and an entry point is exactly the tempting thing to reach
// for, because both hold something a layer would like: `extension.js` has the
// live settings, `prefs.js` the bounds its spin rows use.
...
export default [
...

    {
        ...
        rules: {
            ...
            // One blank line separates; two are a seam nobody meant to leave.
            // Every file here reads as prose, and the spacing is part of that.
...

    {
        files: ['src/domain/**/*.js'],
        rules: restrict(
            [...RUNTIME_IMPORTS, ...ENTRY_POINTS, '**/sysfs/gio.js', '**/hardware/**',
                '**/presentation.js'],
    ...
    },
    {
        ...
        rules: restrict(
            [...RUNTIME_IMPORTS, ...ENTRY_POINTS, '**/sysfs/gio.js', '**/presentation.js'],
    ...
    },
    {
        ...
        rules: restrict(
            [...RUNTIME_IMPORTS, ...ENTRY_POINTS, '**/domain/**', '**/hardware/**',
                '**/presentation.js'],
    ...
    },
    {
        ...
        rules: restrict(
            [...RUNTIME_IMPORTS, ...ENTRY_POINTS, '**/sysfs/**', '**/hardware/**'],
